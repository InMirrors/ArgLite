...
class Formatter {
public:
    static std::string red(std::string_view str, std::ostream &os = std::cerr) {
        return format(str, ANSI_RED, os);
    }

    static std::string bold(std::string_view str, std::ostream &os = std::cout) {
        return format(str, ANSI_BOLD, os);
    }

    static std::string boldUnderline(std::string_view str, std::ostream &os = std::cout) {
...
private:
    ...
    static std::string format(std::string_view str, std::string_view code, std::ostream &os = std::cout) {
        std::string result;
        if (shouldFormat(os)) {
